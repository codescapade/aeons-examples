...
var components_CBunnyMove = function(entityId) {
	aeons_core_Component.call(this,entityId);
};
...
var entities_EBunny = function(id) {
...
entities_EBunny.prototype = $extend(aeons_core_Entity.prototype,{
	create: function() {
		aeons_Aeons._entities.addComponent(this,aeons_components_CTransform).create();
		aeons_Aeons._entities.addComponent(this,components_CBunnyMove).create();
...
entities_ECamera.prototype = $extend(aeons_core_Entity.prototype,{
	create: function() {
		aeons_Aeons._entities.addComponent(this,aeons_components_CTransform).create();
		aeons_Aeons._entities.addComponent(this,aeons_components_CCamera).create();
		return this;
	}
	,__class__: entities_ECamera
});
var entities_EText = function(id) {
	aeons_core_Entity.call(this,id);
};
...
scenes_GameScene.prototype = $extend(aeons_core_Scene.prototype,{
	...
	,create: function() {
		...
		this.sceneProviders.systems.add(systems_SBunny).create();
		aeons_Aeons._assets.loadAtlas("atlas");
		this.sceneProviders.entities.addEntity(entities_ECamera).create();
		this.fps = this.sceneProviders.entities.addEntity(entities_EText).create(10,10,"FPS: 60");
		this.bunnyCount = this.sceneProviders.entities.addEntity(entities_EText).create(10,40,"Bunnies: 0");
		this.createBunny();
	...
	,createBunny: function() {
		var bunny = this.sceneProviders.entities.addEntity(entities_EBunny).create();
...
$hxClasses["systems.SBunny"] = systems_SBunny;
systems_SBunny.__name__ = "systems.SBunny";
systems_SBunny.__interfaces__ = [aeons_core_Updatable];
systems_SBunny.__super__ = aeons_core_System;
systems_SBunny.prototype = $extend(aeons_core_System.prototype,{
	gravity: null
	,maxX: null
	,maxY: null
	,bunnyBundles: null
